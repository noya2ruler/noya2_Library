...
data:
  ...
  bundledCode: "#line 1 \"test/misc/LongestIncreasingSubsequence.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/longest_increasing_subsequence\"\n\
    ...
    */\n\n}\n\nusing namespace noya2;\n\n\n#line 2 \"misc/longest_increasing_subsequence.hpp\"\
    \n\n#line 6 \"misc/longest_increasing_subsequence.hpp\"\n\nnamespace noya2 {\n\
    ...
    \ Tinf) - dp.begin();\n    ids.resize(len);\n    int cid = ids[len-1];\n    for\
    \ (int i = len-1; i >= 0; i--){\n        ids[i] = cid;\n        cid = pre[cid];\n\
    \    }\n    return ids;\n}\n\n} // namespace noya2\n#line 5 \"test/misc/LongestIncreasingSubsequence.test.cpp\"\
    \n\nint main(){\n    int n; in(n);\n    vector<int> a(n); in(a);\n    auto ans\
    \ = longest_increasing_subsequence_ids(a);\n    out(ans.size());\n    out(ans);\n\
    }\n"
  ...
  - template/const.hpp
  - template/utils.hpp
  - misc/longest_increasing_subsequence.hpp
  isVerificationFile: true
  path: test/misc/LongestIncreasingSubsequence.test.cpp
  requiredBy: []
  timestamp: '2024-07-23 15:26:05+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/misc/LongestIncreasingSubsequence.test.cpp
layout: document
redirect_from:
- /verify/test/misc/LongestIncreasingSubsequence.test.cpp
- /verify/test/misc/LongestIncreasingSubsequence.test.cpp.html
