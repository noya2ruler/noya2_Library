...
data:
  ...
  bundledCode: "#line 1 \"test/fps998244353/polynomial_taylor_shift_998244353.test.cpp\"\
    ...
    ~ (. _________ . /)\u3000*/\n\n}\n\nusing namespace noya2;\n\n\n#line 2 \"fps998244353/polynomial_taylor_shift.hpp\"\
    ...
    \ _m;\n    ull  im;\n    explicit barrett(uint m) : _m(m), im((ull)(-1) / m +\
    ...
    \ f[i] *= bnm.ifact(i);\n    return f;\n}\n\n} // namespace \n#line 5 \"test/fps998244353/polynomial_taylor_shift_998244353.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2024-04-24 02:17:25+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/fps998244353/polynomial_taylor_shift_998244353.test.cpp
layout: document
redirect_from:
- /verify/test/fps998244353/polynomial_taylor_shift_998244353.test.cpp
- /verify/test/fps998244353/polynomial_taylor_shift_998244353.test.cpp.html
